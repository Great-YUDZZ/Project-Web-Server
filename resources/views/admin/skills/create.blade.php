...
<div class="max-w-2xl">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-400 font-mono-code mt-0.5">Tambahkan kompetensi teknis ke dalam Skill Matrix.</p>
        </div>
    ...
    <div class="rounded-2xl border border-slate-800 bg-slate-950 p-6 sm:p-8">
        <form action="{{ route('admin.skills.store') }}" method="POST" class="space-y-6 font-mono-code text-xs">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       placeholder="Misal: MikroTik BGP Routing / Nginx SSL Reverse Proxy"
            ...
            <div>
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span id="level-display" class="font-bold text-cyan-400 text-sm">85%</span>
                </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                ...
                <button type="submit" class="px-6 py-2.5 rounded-xl bg-emerald-500 text-black font-bold hover:bg-emerald-400 transition-colors">
                    SIMPAN SKILL &rarr;
                </button>
            </div>
        </form>
