...
<div class="max-w-2xl">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-zinc-400 font-mono mt-0.5">Perbarui nama, kategori, atau persentase penguasaan kompetensi.</p>
        </div>
    ...
    <div class="rounded-3xl border border-white/[0.08] bg-[#0d0e14]/80 backdrop-blur-xl p-6 sm:p-8">
        <form action="{{ route('admin.skills.update', $skill->id) }}" method="POST" class="space-y-6 font-mono text-xs">
            @csrf
            @method('PUT')
            ...
            <div>
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span id="level-display" class="font-bold text-orange-400 text-sm">{{ $skill->level }}%</span>
                </div>
